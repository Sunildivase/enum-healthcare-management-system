...
public class Doctor {
    ...
    public User getSpeciality() {
        return speciality;
    }

    public void setSpeciality(User speciality) {
    ...
    public boolean equals(Object o) {
        ...
        return getDoctorId() == doctor.getDoctorId() && getAge() == doctor.getAge() && getExperience() == doctor.getExperience() && Objects.equals(getFirstName(), doctor.getFirstName()) && Objects.equals(getLastName(), doctor.getLastName()) && Objects.equals(getGender(), doctor.getGender()) && Objects.equals(getContactNo(), doctor.getContactNo()) && getSpeciality() == doctor.getSpeciality();
    }
